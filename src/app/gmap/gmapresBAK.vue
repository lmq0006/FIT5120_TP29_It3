<template>
  ...
  >
    ...
    <gmap-marker v-for="item of nodepointsCpu" :key="item._id" :position="{lng: item.lng, lat: item.lat-0.0009}" :labelOrigin="{x:0,y:0}"
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        map: {},
        center: { lng: 144.979066, lat: -37.822548 },
        zoom: 14,
        points: [],
        icons: [],
        nodepoints: [],
  ...
  created () {
    ...
    methods: {
     ...
     /* getPointsSomehow (BMap) {
      ...
      getNodePoints () {
        const arr = [
          { _id: 1, url: this.node, lng: 144.970478, lat: -37.829343, owner: 0, type: 0, buy: 2000, fee: 500, title: 'Title',subtitle: 'Rest Place',desc1: 'this is desc1 of 1',desc2: 'this is desc2 of 1',info: 'info1', show: false, iconSize: 32 },
          ...
          { _id: 3, url: this.node, lng: 144.979066, lat: -37.827833, owner: 0, type: 0, buy: 2000, fee: 500, title: 'Title',subtitle: 'Rest Place',desc1: 'this is desc1 of 3',desc2: 'this is desc2 of 3',info: 'info3', show: false, iconSize: 32 },
          ...
          { _id: 5, url: this.node, lng: 144.971988, lat: -37.824058, owner: 0, type: 0, buy: 2000, fee: 500, title: 'Title',subtitle: 'Rest Place',desc1: 'this is desc1 of 5',desc2: 'this is desc2 of 5',info: 'info5', show: false, iconSize: 32 },
          ...
          { _id: 7, url: this.node, lng: 144.979066, lat: -37.822548, owner: 0, type: 0, buy: 2000, fee: 500, title: 'Title',subtitle: 'Rest Place',desc1: 'this is desc1 of 7',desc2: 'this is desc2 of 7',info: 'info7', show: false, iconSize: 32 },
          { _id: 8, url: this.node, lng: 144.979066, lat: -37.822548, owner: 0, type: 7, buy: 2000, fee: 500, title: 'Title',subtitle: 'Jang Gun',desc1: 'this is desc1 of 8',desc2: 'this is desc2 of 8',info: 'info8', show: false, iconSize: 32 },
          { _id: 9, url: this.node, lng: 144.971988, lat: -37.818773, owner: 0, type: 0, buy: 2000, fee: 500, title: 'Title',subtitle: 'Rest Place',desc1: 'this is desc1 of 9',desc2: 'this is desc2 of 9',info: 'info9', show: false, iconSize: 32 },
          ...
          { _id: 11, url: this.node, lng: 144.979066, lat: -37.817263, owner: 0, type: 0, buy: 2000, fee: 500, title: 'Title',subtitle: 'Rest Place',desc1: 'this is desc1 of 11',desc2: 'this is desc2 of 11',info: 'info11', show: false, iconSize: 32 },
          ...
          { _id: 13, url: this.node, lng: 144.970478, lat: -37.823303, owner: 0, type: 0, buy: 2000, fee: 500, title: 'Title',subtitle: 'Rest Place',desc1: 'this is desc1 of 13',desc2: 'this is desc2 of 13',info: 'info13', show: false, iconSize: 32 },
